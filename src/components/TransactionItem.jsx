...
const TransactionItem = ({ transaction }) => {
    ...
    return (
        <div>
            <div onClick={() => setViewTransaction(true)} key={transaction.id} className="my-2 px-5 py-3 flex items-center gap-3 hover:bg-accent">
                ...
                <div className={`text-xs ${transaction.type === "income" ? "text-green-700 bg-green-100" : "text-red-700 bg-red-100"} px-2 rounded-full`}>
