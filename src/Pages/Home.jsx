        ...
        <div className="relative h-screen bg-bglight">
            <div className="absolute top-0 w-full p-5">
                <div className="flex justify-between gap-2">
                    ...
                    <button className="border border-primary shadow-lg shadow-zinc-500 py-2 px-4 rounded-full  text-black font-semibold cursor-pointer hover:scale-97 transition ease-in-out flex gap-2 items-center">Login <MdArrowOutward size={28} className="text-black" /> </button>
                </div>
            </div>
